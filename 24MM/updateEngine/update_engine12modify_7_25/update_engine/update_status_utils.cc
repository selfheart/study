...
const char kIautoNeedNextPackage[] = "IAUTO_NEED_NEXT_PACKAGE";
...
#ifdef UPDATE_ENGINE_FOR_CAR
    case UpdateStatus::IAUTO_REPORTING_UPDATE_OBJECTS:
      return kIautoReportingUpdateObjects;
    case UpdateStatus::IAUTO_NEED_NEXT_PACKAGE:
      return kIautoNeedNextPackage;
#endif  // #ifdef UPDATE_ENGINE_FOR_CAR
  }
