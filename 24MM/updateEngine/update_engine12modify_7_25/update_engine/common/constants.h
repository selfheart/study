...
extern const char kPayloadPropertyPassword[];

// Is is a need resume flag. If the value is 0, not need resume. Otherwase
// update_engine need resume.
extern const char kPayloadPropertyNeedResume[];

// if has soc need unboot
extern const char kPayloadPropertyNeedUNBOOT[];

// iauto reporting update objects
extern const char kIautoReportingUpdateObjects[];

extern const char kPayloadPropertySplitSize[];
extern const char kPayloadPropertySplitHash[];
extern const char kPayloadPropertySplitFlag[];
extern const char kPayloadPropertySplitCount[];
extern const char kPayloadPropertySplitNumber[];
extern const char kPrefsUpdateStateSplitOffsetNow[];
extern const char kPrefsUpdateStateSplitDataOffset[];
extern const char kPrefsUpdateStateSplitHashContext[];
extern const char kPrefsUpdateStateSplitPackageSHA256Context[];
extern const char kPrefsUpdateStateSplitPackageSignedSHA256Context[];
