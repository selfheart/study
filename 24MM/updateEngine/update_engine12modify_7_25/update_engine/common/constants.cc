...
// The password is for decryption payload data.
// The password is  base64 format.
const char kPayloadPropertyPassword[] = "PASSWORD";

// Is is a need resume flag. If the value is 0, not need resume. Otherwase
// update_engine need resume.
const char kPayloadPropertyNeedResume[] = "NEED_RESUME";

// if update SOC, NEED_UNBOOT==1
const char kPayloadPropertyNeedUNBOOT[] = "NEED_UNBOOT";

// iauto reporting update objects
const char kIautoReportingUpdateObjects[] = "IAUTO_REPORTING_UPDATE_OBJECTS";


const char kPayloadPropertySplitSize[] = "SPLIT_SIZE";
const char kPayloadPropertySplitHash[] = "SPLIT_HASH";
const char kPayloadPropertySplitFlag[] = "split_flag";
const char kPayloadPropertySplitCount[] = "split_count";
const char kPayloadPropertySplitNumber[] = "split_number";
const char kPrefsUpdateStateSplitOffsetNow[] = "update-state-split-offset-now";
const char kPrefsUpdateStateSplitDataOffset[] = "update-state-split-data-offset";
const char kPrefsUpdateStateSplitHashContext[] = "update-state-split-hash-context";
const char kPrefsUpdateStateSplitPackageSHA256Context[] = "update-state-split-package-sha256-context";
const char kPrefsUpdateStateSplitPackageSignedSHA256Context[] = "update-state-split-package-signed-sha256-context";
