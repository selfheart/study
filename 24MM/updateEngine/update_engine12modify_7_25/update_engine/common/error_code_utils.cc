...
string ErrorCodeToString(ErrorCode code) {
  ...
  switch (code) {
    ...
    case ErrorCode::kModeIDError:
      return "ErrorCode::kModeIDError";
    case ErrorCode::kConfigFile:
      return "ErrorCode::kConfigFile";
    case ErrorCode::kCloseError:
      return "ErrorCode::kCloseError";
