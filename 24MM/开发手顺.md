...
update TBL_STRING_ITEMS set VALUE="CCABAAAAAAGP" where KEY="DM_BK_STRING_CHIPNO_INFO";
...
setprop persist.iauto.log.switch 31
logcat -G 256m && logcat  -g
logcat -s OTA-MASTER  OTA-COMPOSER  UPDATE_AGENT   TLSProxy update_engine telema-tsc  & 

date "2024-01-09 14:36:20"
